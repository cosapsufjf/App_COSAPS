...
import Registro from "@/app/components/Register/Register";
...
const CRUD : React.FC = () => {
    ...
    const [LoginRegister, setLoginRegister] = useState<{page: React.FC, show: boolean}>(
        {
            "page": Registro,
            "show": true
        });
    ...
    useEffect(() => {
        setTimeout(() => {
            ...
            setLoginRegister({"page": Login,"show": true});
        }, 2000);
    },[])
    ...
    const card_selector = ()=>{
        ...
        return(
            <View style={styles.card_selector}>
                <TouchableOpacity style={style_btn(btnsColors[0])} 
                onPress={() => selectScreen(Registro)}
                >
                    <Text>Register</Text>
                </TouchableOpacity>
                <TouchableOpacity style={style_btn(btnsColors[1])}
